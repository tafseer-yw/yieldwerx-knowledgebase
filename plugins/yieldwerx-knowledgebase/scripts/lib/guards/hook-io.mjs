/**
 * Shared PreToolUse plumbing for the knowledgebase guards.
 *
    ...
    JSON.stringify({
      ...
      systemMessage:
        verdict.decision === "deny"
          ? "knowledgebase guard blocked this - see the reason."
          : "knowledgebase guard wants the owner's decision before this proceeds.",
    }),
  );
  return true;
}
